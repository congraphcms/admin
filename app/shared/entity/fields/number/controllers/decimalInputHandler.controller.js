...
export default class DecimalInputHandlerController{
  ...
  setDefaultValue() {
    ...
    if(defaultValue) {
      handler.entity.setField(handler.fieldCode, parseFloat(defaultValue));
    }
  }
}

DecimalInputHandlerController.$inject = [
  '$scope',
  '$rootScope',
  '$state',
  '$stateParams',
